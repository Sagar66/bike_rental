...
<div class="bike-rent-index">
    ...
    <p>
        <?= Html::a('Rent Again', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute'=>'bike_fk',
                'value'=>function($a){
        return app\models\Bike::findOne($a->bike_fk)->name;
                }
            ],
            [
                'attribute'=>'customer_fk',
                'value'=>function($a){
        return app\models\Customer::findOne($a->customer_fk)->full_name;
                }
            ],
            ...
            ['class' => 'yii\grid\ActionColumn','template'=>'{view}','buttons'=>[
                ...
                return Html::a("<span class='glyphicon glyphicon-ok'></span> Unbook", ['update','id'=>$key->id], ['class' => 'btn btn-primary btn-xs']);
                },
            ]],
        ],
    ]); ?>
