...
$this->title = $model->bike_fk;
$this->params['breadcrumbs'][] = ['label' => 'Bike Rents', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="bike-rent-view">

    <h1 style="text-align: center"><?= Html::encode($this->title) ?></h1>
<p>
    <?= Html::a('Back', Yii::$app->request->referrer,['class' => 'glyphicon glyphicon-chevron-left btn btn-danger large']); ?>
    <span style="text-align: right;float: right;"><?= Html::a('UpdateRent', ['update', 'id' => $model->id], ['class' => 'glyphicon glyphicon-refresh btn btn-success large']) ?></span>
</p>
<!--    <p>
